...
class RAGSearcher:
    ...
    def search(self, query: str):
        logger.info(f"Running RAG search in namespace '{self.namespace}' for query: {query[:100]}...")
    ...
    async def async_search(self, query: str):
        logger.info(f"Running async RAG search in namespace '{self.namespace}' for query: {query[:100]}...")
        try:
            ...
            logger.error(f"RAG search failed for query '{query[:100]}...' in namespace '{self.namespace}': {e}")
            return []
