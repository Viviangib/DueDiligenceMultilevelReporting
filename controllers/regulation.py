...
async def process_regulation(db: Session, file_path: str, regulation_id: int):
...
#     """Run async embedding task in the background"""
#     asyncio.create_task(regulation_service.process_regulation(db, file_path, regulation_id))
